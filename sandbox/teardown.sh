...
# Destroys the KinD cluster and cleans up local storage directories
# =============================================================================
set -euo pipefail
...
echo -e "${CYAN}[INFO]${NC} Cleaning up local storage..."
rm -rf /tmp/virtcloud-sandbox/

echo -e "${GREEN}[OK]${NC}   Sandbox destroyed. Run 'bash sandbox/bootstrap.sh' to recreate."
